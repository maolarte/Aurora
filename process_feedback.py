...
def main(cara_path: str, feedback_path: str, monitoreo_path: str, info_path: str, destination: str = "", output_path: str = "", output_format: str = "csv"):
...
# Adding coordinates of variables (país de nacimiento, país donde inicio el viaje and país donde vivía hace un año)
   ...
   # Chile
    ...
    aurora_comple.loc[aurora_comple['UserId']==317308056, 'country_name'] = "Colombia"
    aurora_comple.loc[aurora_comple['UserId']==319708059, 'country_name'] = "Chile"
...
## Dataset of general feedback 
    ...
    feedback_NNA = feedback_NNA[feedback_NNA['tipo'].isin(['Enganche', 'Feedback'])]
    ...
    df2=df.explode(['Ayuda_NNA', 'Acceso_NNA','Satisfaccion_NNA','Recomendacion_NNA'])
    ...
    df2['Satisfaccion_NNA'] = df2['Satisfaccion_NNA'].apply(lambda x: satMap(x))
    
    df2.to_csv('feedback_NNA.csv', index=False) ######integrate 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_path', type=str, required=True,
                        help="File location path for Aurora data")
    ...
    main(cara_path=cara_path, feedback_path=ayuda_path, monitoreo_path=mon_path, info_path=info_path, destination=destination,
